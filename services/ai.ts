...
const OPENROUTER_BASE_URL = import.meta.env.VITE_GEMINI_API_BASE_URL || "https://openrouter.ai/api/v1";
const ACTIVE_MODEL = import.meta.env.VITE_ACTIVE_MODEL || "openrouter/auto";
const SITE_URL = 'http://localhost:3000';
const SITE_NAME = 'Askari Security SaaS';

// 🔄 "INDIE" FREE MODEL LIST (Low Traffic & Stable)
// The user-selected ACTIVE_MODEL is prioritized, followed by stable fallbacks.
const MODELS = [
  ACTIVE_MODEL,
