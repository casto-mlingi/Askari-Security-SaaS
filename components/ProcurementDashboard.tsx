                ...
                {items.map(it => (
                  <tr key={it.id} className="border-b">
                    ...
                    <td className="py-3 px-2 text-right">
                      <button onClick={() => openRestock(it)} className="px-3 py-1.5 bg-emerald-600 text-white text-[10px] font-black uppercase rounded-lg disabled:opacity-50">Restock</button>
                    </td>
                  </tr>
                ))}
                {items.length === 0 && (
