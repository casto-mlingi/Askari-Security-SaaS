  ...
  return (
    <div className="max-w-7xl mx-auto space-y-10 pb-24 animate-in fade-in duration-500">
          ...
          return (
            ...
            >
              <div className="flex justify-between items-start mb-8">
                <div className="w-16 h-16 bg-slate-50 text-slate-900 rounded-[1.5rem] flex items-center justify-center font-black text-2xl shadow-sm border border-slate-200 shadow-xl ring-4 ring-slate-100">
                  {company.name?.[0] || 'C'}
                </div>
      ...
      {selectedCompanyId && drillDownCompany && drillDownData && (
        <div className="fixed inset-0 z-[1100] bg-slate-900/60 backdrop-blur-md flex items-center justify-center p-0 md:p-8 animate-in fade-in duration-300">
          <div className="bg-white w-full max-w-6xl h-full md:h-[90vh] md:rounded-[4rem] shadow-2xl flex flex-col overflow-hidden border border-slate-200/50">
             <div className="p-10 border-b-2 border-slate-100 flex justify-between items-center bg-white text-slate-900 shadow-sm">
                 ...
                 <button onClick={() => setSelectedCompanyId(null)} className="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center hover:bg-red-500 hover:text-white transition-all border border-slate-200">✕</button>
              </div>
