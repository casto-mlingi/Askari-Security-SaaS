...
// IDs for Second Company (Askari Global) Staff
...
const S_BANK_ID = 's-2';
const S_MALL_ID = 's-3';
const S_PORT_ID = 's-4'; // Askari Global Site
...
const G_ASKARI_GUARD_ID = 'g-ag-1'; // Askari Global Guard
...
export const MOCK_COMPANIES: Company[] = [
  ...
  { id: C_ASKARI_ID, name: 'Askari Global', slug: 'askari-global', contact_email: 'ops@askari.global', is_active: true, created_at: '2023-02-15T12:00:00Z' },
];

export const MOCK_PROFILES: Profile[] = [
  // Super Admin
  { id: P_SUPER_ADMIN_ID, full_name: 'Sys Admin', role: UserRole.SUPER_ADMIN, email: 'admin@askari.com', is_active: true, created_at: '2023-01-01T00:00:00Z', password: 'pass123' },
  ...
  { id: P_HR_ID, full_name: 'Peter HR', role: UserRole.HR_OFFICER, email: 'hr@askari.com', company_id: C_ULTIMATE_ID, is_active: true, created_at: '2023-01-11T00:00:00Z', password: 'pass123' },
  { id: P_PROCURE_ID, full_name: 'Susan Supply', role: UserRole.PROCUREMENT, email: 'supply@askari.com', company_id: C_ULTIMATE_ID, is_active: true, created_at: '2023-01-12T00:00:00Z', password: 'pass123' },
  { id: P_SUPERVISOR_ID, full_name: 'Sgt. Major', role: UserRole.SUPERVISOR, email: 'field@askari.com', company_id: C_ULTIMATE_ID, is_active: true, created_at: '2023-01-13T00:00:00Z', password: 'pass123', current_site_id: S_BANK_ID },
  ...
  // Askari Global Staff (For Multi-Tenant Testing)
  { id: P_ADMIN_AG_ID, full_name: 'Global Director', role: UserRole.COMPANY_ADMIN, email: 'director@askariglobal.com', company_id: C_ASKARI_ID, is_active: true, created_at: '2023-06-01T00:00:00Z', password: 'pass123' },
  { id: P_HR_AG_ID, full_name: 'Global HR', role: UserRole.HR_OFFICER, email: 'hr@askariglobal.com', company_id: C_ASKARI_ID, is_active: true, created_at: '2023-06-02T00:00:00Z', password: 'pass123' },
  { id: P_SUP_AG_ID, full_name: 'Captain Global', role: UserRole.SUPERVISOR, email: 'ops@askariglobal.com', company_id: C_ASKARI_ID, is_active: true, created_at: '2023-06-03T00:00:00Z', password: 'pass123', current_site_id: S_PORT_ID },
];
...
export const MOCK_SITES: Site[] = [
  ...
  { id: S_PORT_ID, name: 'Dar Port Terminal', lat: -6.83, lng: 39.29, geofence_radius_meters: 500, company_id: C_ASKARI_ID, supervisor_id: P_SUP_AG_ID, created_at: '2023-06-10T00:00:00Z' },
];
...
export const MOCK_GUARDS: Guard[] = [
  ...
  { 
    ...
    company_id: C_ASKARI_ID, 
    assigned_supervisor_id: P_SUP_AG_ID, 
    phone: '0755123456', 
    is_armed: true, 
    consecutive_absences: 0, 
    created_at: '2023-06-15T00:00:00Z', 
    username: 'guard@askariglobal.com', 
    password: 'pass123',
    education_history: [],
    guarantors: [],
    dossier_data: {}
...
export const MOCK_EQUIPMENT: EquipmentItem[] = [
  ...
  // Askari Global Equipment
  { id: 'eq-ag-1', company_id: C_ASKARI_ID, sku: 'AG-U-001', name: 'Global Uniform Set', category: 'uniform', stock_quantity: 50, created_at: '2023-06-05T00:00:00Z' },
];
...
export const MOCK_ANNOUNCEMENTS: Announcement[] = [
  ...
  { id: 'ann-3', company_id: C_ASKARI_ID, title: 'Global Security Alert', content: 'Increased vigilance advised due to regional instability.', author_profile_id: P_SUPER_ADMIN_ID, author_name: 'Sys Admin', created_at: '2023-05-05T09:00:00Z' },
];
